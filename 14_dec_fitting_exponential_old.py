...
sensor_data.filter_by_date(start_date="10/11/2024 13:00", end_date="10/12/2024 07:00")
...
plt.gca().set_xlabel('Time s', fontsize=14)
plt.gca().set_ylabel('Temp C', fontsize=14)
