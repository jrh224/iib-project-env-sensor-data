...
X_train, y_train = create_sequences(train_matrix, lookback=config.LOOKBACK, predictforward=config.OUTPUT_SIZE, target_col=0)
...
torch.save(model.state_dict(), '15feb1833.pth')