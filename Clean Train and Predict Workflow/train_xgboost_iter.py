...
save_model_as = "optimal_singleoutput_xgb_model_room3.pkl"
...
joblib.dump(scalers, "scalers_room3.gz") # Store all the scalers in order to be used when predicting
...
params = {'n_estimators': 616, 'max_depth': 5, 'learning_rate': 0.038870319578503676, 'subsample': 0.9967963559934084, 'colsample_bytree': 0.9173048946848635, 'reg_alpha': 3.2718055286138705e-05, 'reg_lambda': 9.888592449597026e-05}
